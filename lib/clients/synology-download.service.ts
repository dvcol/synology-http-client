...
import type { DownloadStationConfig, DownloadStationInfo, DownloadStationStatistic } from '~/models/synology-download.model';
import type { TaskList, TaskListOption } from '~/models/synology-task.model';

import type { CommonResponse, TaskCreateRequest } from '~/models/synology.model';
