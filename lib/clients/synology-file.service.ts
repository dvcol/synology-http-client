...
import type { FileList, FileListOption, FileSortBy } from '~/models/synology-file.model';
import type { FolderList, FolderListOption, FolderSortBy, NewFolderList } from '~/models/synology-folder.model';
...
export class SynologyFileService extends SynologyService {
  constructor(protected name: string = 'SynologyFileService') {
    super(name);
  }
